                        ...
                        <div class="col-md-12">
                            <form method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="<?php echo number_format($row['ParkingTimer'], 2); ?>" readonly>
                                </div>

                                <div class="form-group">
                                    <label>Total Charge</label>
                                    <input type="text" class="form-control" value="PHP <?php echo number_format($row['ParkingCharge'], 2); ?>" readonly>
                                </div>
                                ...
                                <div class="form-group">
                                    <label>Remarks</label>
                                    <input type="text" class="form-control" value="<?php echo $row['Remark']; ?>" readonly>
                                </div>
